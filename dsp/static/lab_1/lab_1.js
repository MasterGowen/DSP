...
function DSPXBlock(runtime, element, data) {
    ...
    function build_graphics() {
        $("#graphic_1", element).html("<div style='background: #f3f3f2;width: 100%;height: 100%;'><div class='lds-ripple'><div></div><div></div></div></div>");
        $("#graphic_2", element).html("<div style='background: #f3f3f2;width: 100%;height: 100%;'><div class='lds-ripple'><div></div><div></div></div></div>");
        $.ajax({
            type: "POST",
            url: get_graphics,
